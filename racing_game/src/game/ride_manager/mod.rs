...
use super::city_map::road_path::RoadPath;
...
impl RideManager {
    pub fn new() -> RideManager {
        ...
        RideManager { road, car, horizon, camera}
    }
    ...
    pub fn update(&mut self, delta_time : f32) {
        self.road.compute_y_data(&self.camera, screen_height);
    ...
    pub fn render(&self, buffer : &mut RgbImage) {
        self.horizon.render(self.road.y_data.len() as u32 - 1, 0.0, buffer);
        self.road.render_from_y_data(buffer, &self.camera);
