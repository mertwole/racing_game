...
impl<E : Clone> UISelector<E> {
    pub fn new(items : Vec<UISelectorItem<E>>, selection_type : SelectionType, pointer_image : RgbaImage, pointer_offset : IVec2, resolution : IVec2, background_color : Option<Rgb<u8>>) -> UISelector<E> {
